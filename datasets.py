...
def build_dataset(split, args, transform):
    ...
    assert args.data_set in ['UCF101', 'HMDB51', 'Kinetics', 'ANet']
    ...
    dataset = ClassificationDataset(
        args.data_root_train if is_train else args.data_root_val, # root
        list_file,
        split=split,
